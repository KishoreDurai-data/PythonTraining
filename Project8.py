...
students = [
    Student("Mani", 1, "IT", 65000),
    Student("Aruna", 2, "ECE", 40000)
]

faculty = [
    Faculty("Sasi", 101, 35000),
    Faculty("Bharath", 102, 28000)
]
...
students = [
    Student("Mani", 1, "IT", 65000),
    Student("Aruna", 2, "ECE", 40000),
    Student("Paul", 3, "CSC", 70000)
]

faculty = [
    Faculty("Alice", 101, 35000),
    Faculty("Bob", 102, 28000),
    Faculty("David", 103, 55000)
]
